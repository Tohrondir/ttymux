  ...
  return (
    <aside className="flex w-72 shrink-0 flex-col border-r border-line bg-panel">
      ...
      <button
        ...
        className={`flex items-center justify-between border-b border-line px-4 py-2 text-left text-sm transition-colors ${
          gridActive ? 'bg-panel-raised text-paper' : 'text-fog hover:bg-panel-raised hover:text-paper'
        }`}
      >
        <span>&#9635; Grid view</span>
